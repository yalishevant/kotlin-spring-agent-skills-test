This Spring Boot project compiles and basic tests pass. However, there are verification tests in `JacksonVerificationTest.kt` that are `@Disabled` because they fail.
